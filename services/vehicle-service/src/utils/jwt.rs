...
// TokenClaims structure khusus untuk Vehicle Service
...
mod tests {
    ...
    fn test_validate_access_token() {
        ...
        let token = create_test_token(123, "seller@example.com", "seller", "access");
    ...
    fn test_reject_refresh_token() {
        ...
        let token = create_test_token(123, "seller@example.com", "seller", "refresh");
        let result = decode_jwt_token(&token);
